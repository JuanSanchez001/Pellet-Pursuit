...
public abstract class Ghost extends Sprite {
    ...
    public boolean collidesWith(Player p) {
        ...
        double distanceBetween = distanceTo(p.centerX(), p.centerY());
        if (distanceBetween < size)// i chose < size because it causes pac man to lose as soon as it is touched and vice versa when ghost is frightened
        {
            return true;
        }
